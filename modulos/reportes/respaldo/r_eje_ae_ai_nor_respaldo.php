...
class PDF extends FPDF
{
	function Header()
	{
		...
		$this->SetY(44);$this->SetX(1);
		$this->Cell(30,3,'Partida',0,0,'L',1);
		$this->SetY(44);$this->SetX(28);
		$this->Cell(100,3,'Descripción',0,0,'L',1);
		$this->SetY(44);$this->SetX(90);
		$this->Cell(20,3,'Ene.',0,0,'L',1);
		$this->SetY(44);$this->SetX(105);
		$this->Cell(20,3,'Feb.',0,0,'L',1);
		$this->SetY(44);$this->SetX(120);
		$this->Cell(20,3,'Mar.',0,0,'L',1);
		$this->SetY(44);$this->SetX(135);
		$this->Cell(20,3,'Abr.',0,0,'L',1);
		$this->SetY(44);$this->SetX(150);
		$this->Cell(20,3,'May.',0,0,'L',1);
		$this->SetY(44);$this->SetX(165);
		$this->Cell(20,3,'Jun.',0,0,'L',1);
		$this->SetY(44);$this->SetX(180);
		$this->Cell(20,3,'Jul.',0,0,'L',1);
		$this->SetY(44);$this->SetX(195);
		$this->Cell(20,3,'Ago.',0,0,'L',1);
		$this->SetY(44);$this->SetX(210);
		$this->Cell(20,3,'Sep.',0,0,'L',1);
		$this->SetY(44);$this->SetX(225);
		$this->Cell(20,3,'Oct.',0,0,'L',1);
		$this->SetY(44);$this->SetX(240);
		$this->Cell(20,3,'Nov.',0,0,'L',1);
		$this->SetY(44);$this->SetX(255);
		$this->Cell(20,3,'Dic.',0,0,'L',1);
		$this->SetY(44);$this->SetX(270);
	...
	$db=DB_CONECCION();
		...
		if (!$grupo_eje ->EOF)
		{
			...
			$pdf->SetY(37);$pdf->SetX(1);$pdf->Cell(35,3,'Unidad Ejecutora Normativo:',0,0,'L');
			$pdf->Cell(50,3,$grupo_eje ->fields['descripcion'],0,0,'L');
			...
			$SQL = ("SELECT safor_pry_ae_eje_um.id_um, 
				...
				{	
					$pdf->SetFont('Arial','',8);
					$pdf->SetX(6);$pdf->Cell(10,5,$grupo_part->fields['id_um'],'C');
					$pdf->SetX(18);$pdf->Cell(40,5,$grupo_part->fields['descrip']);

					$pdf->SetX(90);$pdf->Cell(5,5,number_format($grupo_part->fields['ene'],0,',','.'),0,0,'R');
					$pdf->SetX(105);$pdf->Cell(5,5,number_format($grupo_part->fields['feb'],0,',','.'),0,0,'R');
					$pdf->SetX(120);$pdf->Cell(5,5,number_format($grupo_part->fields['mar'],0,',','.'),0,0,'R');
					$pdf->SetX(135);$pdf->Cell(5,5,number_format($grupo_part->fields['abr'],0,',','.'),0,0,'R');
					$pdf->SetX(150);$pdf->Cell(5,5,number_format($grupo_part->fields['may'],0,',','.'),0,0,'R');
					$pdf->SetX(165);$pdf->Cell(5,5,number_format($grupo_part->fields['jun'],0,',','.'),0,0,'R');
					$pdf->SetX(180);$pdf->Cell(5,5,number_format($grupo_part->fields['jul'],0,',','.'),0,0,'R');
					$pdf->SetX(195);$pdf->Cell(5,5,number_format($grupo_part->fields['ago'],0,',','.'),0,0,'R');
					$pdf->SetX(210);$pdf->Cell(5,5,number_format($grupo_part->fields['sep'],0,',','.'),0,0,'R');
					$pdf->SetX(225);$pdf->Cell(5,5,number_format($grupo_part->fields['oct'],0,',','.'),0,0,'R');
					$pdf->SetX(240);$pdf->Cell(5,5,number_format($grupo_part->fields['nov'],0,',','.'),0,0,'R');
					$pdf->SetX(255);$pdf->Cell(5,5,number_format($grupo_part->fields['dic'],0,',','.'),0,0,'R');
					$pdf->SetX(273);$pdf->Cell(5,5,number_format($grupo_part->fields['total'],0,',','.'),0,0,'R');
					$pdf->Ln();
				...
				$SQL = ("SELECT safor_ai.id_ai, 
					...
					while(!$grupo_ai->EOF)
						...
						while(!$grupo_ai_um->EOF)
							{
								$pdf->SetFont('Arial','',8);
								//$pdf->SetX(12);$pdf->Cell(10,5,$grupo_ai_um->fields['id_um'],'C');
								$pdf->SetX(26);$pdf->Cell(40,5,$grupo_ai_um->fields['descripci']);
								$pdf->SetX(90);$pdf->Cell(5,5,number_format($grupo_ai_um->fields['ene'],0,',','.'),0,0,'R');
								$pdf->SetX(105);$pdf->Cell(5,5,number_format($grupo_ai_um->fields['feb'],0,',','.'),0,0,'R');
								$pdf->SetX(120);$pdf->Cell(5,5,number_format($grupo_ai_um->fields['mar'],0,',','.'),0,0,'R');
								$pdf->SetX(135);$pdf->Cell(5,5,number_format($grupo_ai_um->fields['abr'],0,',','.'),0,0,'R');
								$pdf->SetX(150);$pdf->Cell(5,5,number_format($grupo_ai_um->fields['may'],0,',','.'),0,0,'R');
								$pdf->SetX(165);$pdf->Cell(5,5,number_format($grupo_ai_um->fields['jun'],0,',','.'),0,0,'R');
								$pdf->SetX(180);$pdf->Cell(5,5,number_format($grupo_ai_um->fields['jul'],0,',','.'),0,0,'R');
								$pdf->SetX(195);$pdf->Cell(5,5,number_format($grupo_ai_um->fields['ago']),0,0,'R');
								$pdf->SetX(210);$pdf->Cell(5,5,number_format($grupo_ai_um->fields['sep'],0,',','.'),0,0,'R');
								$pdf->SetX(225);$pdf->Cell(5,5,number_format($grupo_ai_um->fields['oct'],0,',','.'),0,0,'R');
								$pdf->SetX(240);$pdf->Cell(5,5,number_format($grupo_ai_um->fields['nov'],0,',','.'),0,0,'R');
								$pdf->SetX(255);$pdf->Cell(5,5,number_format($grupo_ai_um->fields['dic'],0,',','.'),0,0,'R');
								$pdf->SetX(270);$pdf->Cell(5,5,number_format($grupo_ai_um->fields['total'],0,',','.'),0,0,'R');
								$pdf->Ln();
