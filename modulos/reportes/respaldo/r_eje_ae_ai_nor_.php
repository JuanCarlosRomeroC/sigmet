...
class PDF extends FPDF
{
	...
	function Footer()
	{
		...
		$this->Setx(150);$this->SetTextColor(255,0,0);	$this->Cell(0,10,'D: Deficiente',0,0,'C');
		$this->Setx(200);$this->SetTextColor(230,230,0);	$this->Cell(0,10,'R: Regular ',0,0,'C');
		$this->Setx(250);$this->SetTextColor(0,240,0);	$this->Cell(0,10,'E: Eficiente ',0,0,'C');
				...
				{	
					...
					if($grupo_part->fields['por_ene']>=0) 
					{
						if($grupo_part->fields['por_ene']<=40) 
					         {
						 $pdf->SetX(41);$pdf->Cell(5,5,number_format($grupo_part->fields['por_ene'],0,',','.'),0,0,'R');$pdf->Cell(2,5,'%'); $pdf->SetTextColor(255,0,0);$pdf->Cell(2,5,'');$pdf->Cell(2,5,'D');
					...
					if($grupo_part->fields['por_ene']>=41) 
					{
						if($grupo_part->fields['por_ene']<=80) 
					         {
						  $pdf->SetX(41); $pdf->Cell(5,5,number_format($grupo_part->fields['por_ene'],0,',','.'),0,0,'R');$pdf->Cell(2,5,'%');$pdf->SetTextColor(230,230,0);$pdf->Cell(2,5,'');$pdf->Cell(2,5,'R');
					...
					if($grupo_part->fields['por_ene']>=81) 
					{
						if($grupo_part->fields['por_ene']<=120) 
					         {
						   $pdf->SetX(41);$pdf->Cell(5,5,number_format($grupo_part->fields['por_ene'],0,',','.'),0,0,'R');$pdf->Cell(2,5,'%');$pdf->SetTextColor(0,240,0);$pdf->Cell(2,5,'');$pdf->Cell(2,5,'E');
					}}$pdf->SetTextColor(0,0,0);
					...
					if($grupo_part->fields['por_feb']>=0) 
					{
						if($grupo_part->fields['por_feb']<=40) 
					         {
						   $pdf->SetX(59);$pdf->Cell(5,5,number_format($grupo_part->fields['por_feb'],0,',','.'),0,0,'R');$pdf->Cell(1,5,'%'); $pdf->SetTextColor(255,0,0);$pdf->Cell(2,5,'');$pdf->Cell(2,5,'D');
					...
					if($grupo_part->fields['por_feb']>=41) 
					{
						if($grupo_part->fields['por_feb']<=80) 
					         {
						   $pdf->SetX(59);$pdf->Cell(5,5,number_format($grupo_part->fields['por_feb'],0,',','.'),0,0,'R');$pdf->Cell(1,5,'%'); $pdf->SetTextColor(230,230,0);$pdf->Cell(2,5,'');$pdf->Cell(2,5,'R');
					...
					if($grupo_part->fields['por_feb']>=81) 
					{
						if($grupo_part->fields['por_feb']<=120) 
					         {
						   $pdf->SetX(59);$pdf->Cell(5,5,number_format($grupo_part->fields['por_feb'],0,',','.'),0,0,'R');$pdf->Cell(1,5,'%'); $pdf->SetTextColor(0,240,0);$pdf->Cell(2,5,'');$pdf->Cell(2,5,'E');
					}}$pdf->SetTextColor(0,0,0);
					...
					if($grupo_part->fields['por_mar']>=0) 
					{
						if($grupo_part->fields['por_mar']<=40) 
					         {
						   $pdf->SetX(80);$pdf->Cell(5,5,number_format($grupo_part->fields['por_mar'],0,',','.'),0,0,'R');$pdf->Cell(1,5,'%');$pdf->SetTextColor(255,0,0);$pdf->Cell(2,5,'');$pdf->Cell(2,5,'D');
					...
					if($grupo_part->fields['por_mar']>=41) 
					{
						if($grupo_part->fields['por_mar']<=80) 
					         {
						  $pdf->SetX(80);$pdf->Cell(5,5,number_format($grupo_part->fields['por_mar'],0,',','.'),0,0,'R');$pdf->Cell(1,5,'%'); $pdf->SetTextColor(230,230,0);$pdf->Cell(2,5,'');$pdf->Cell(2,5,'R');
					...
					if($grupo_part->fields['por_mar']>=81) 
					{
						if($grupo_part->fields['por_mar']<=120) 
					         {
						   $pdf->SetX(80);$pdf->Cell(5,5,number_format($grupo_part->fields['por_mar'],0,',','.'),0,0,'R');$pdf->Cell(1,5,'%'); $pdf->SetTextColor(0,240,0);$pdf->Cell(2,5,'');$pdf->Cell(2,5,'E');
					}}$pdf->SetTextColor(0,0,0);
					...
					if($grupo_part->fields['por_abr']>=0) 
					{
						if($grupo_part->fields['por_abr']<=40) 
					         {
						   $pdf->SetX(99); $pdf->Cell(5,5,number_format($grupo_part->fields['por_abr'],0,',','.'),0,0,'R');$pdf->Cell(1,5,'%'); $pdf->SetTextColor(255,0,0);$pdf->Cell(2,5,'');$pdf->Cell(2,5,'D');
					...
					if($grupo_part->fields['por_abr']>=41) 
					{
						if($grupo_part->fields['por_abr']<=80) 
					         {
						   $pdf->SetX(99);$pdf->Cell(5,5,number_format($grupo_part->fields['por_abr'],0,',','.'),0,0,'R');$pdf->Cell(1,5,'%');$pdf->SetTextColor(230,230,0);$pdf->Cell(2,5,'');$pdf->Cell(2,5,'R');
					...
					if($grupo_part->fields['por_abr']>=81) 
					{
						if($grupo_part->fields['por_abr']<=120) 
					         {
						   $pdf->SetX(99);$pdf->Cell(5,5,number_format($grupo_part->fields['por_abr'],0,',','.'),0,0,'R');$pdf->Cell(1,5,'%');$pdf->SetTextColor(0,240,0);$pdf->Cell(2,5,'');$pdf->Cell(2,5,'E');
					}}$pdf->SetTextColor(0,0,0);
					...
					if($grupo_part->fields['por_may']>=0) 
					{
						if($grupo_part->fields['por_may']<=40) 
					         {
						   $pdf->SetX(116);$pdf->Cell(5,5,number_format($grupo_part->fields['por_may'],0,',','.'),0,0,'R');$pdf->Cell(1,5,'%');$pdf->SetTextColor(255,0,0);$pdf->Cell(2,5,'');$pdf->Cell(2,5,'D');
					...
					if($grupo_part->fields['por_may']>=41) 
					{
						if($grupo_part->fields['por_may']<=80) 
					         {
						   $pdf->SetX(116);$pdf->Cell(5,5,number_format($grupo_part->fields['por_may'],0,',','.'),0,0,'R');$pdf->Cell(1,5,'%');$pdf->SetTextColor(230,230,0);$pdf->Cell(2,5,'');$pdf->Cell(2,5,'R');
					...
					if($grupo_part->fields['por_may']>=81) 
					{
						if($grupo_part->fields['por_may']<=120) 
					         {
						   $pdf->SetX(116);$pdf->Cell(5,5,number_format($grupo_part->fields['por_may'],0,',','.'),0,0,'R');$pdf->Cell(1,5,'%');$pdf->SetTextColor(0,240,0);$pdf->Cell(2,5,'');$pdf->Cell(2,5,'E');
					}}$pdf->SetTextColor(0,0,0);
					...
					if($grupo_part->fields['por_jun']>=0) 
					{
						if($grupo_part->fields['por_jun']<=40) 
					         {
						   $pdf->SetX(133); $pdf->Cell(5,5,number_format($grupo_part->fields['por_jun'],0,',','.'),0,0,'R');$pdf->Cell(1,5,'%');$pdf->SetTextColor(255,0,0);$pdf->Cell(2,5,'');$pdf->Cell(2,5,'D');
					...
					if($grupo_part->fields['por_jun']>=41) 
					{
						if($grupo_part->fields['por_jun']<=80) 
					         {
						   $pdf->SetX(133);$pdf->Cell(5,5,number_format($grupo_part->fields['por_jun|'],0,',','.'),0,0,'R');$pdf->Cell(1,5,'%');$pdf->SetTextColor(230,230,0);$pdf->Cell(2,5,'');$pdf->Cell(2,5,'R');
					...
					if($grupo_part->fields['por_jun']>=81) 
					{
						if($grupo_part->fields['por_jun']<=120) 
					         {
						   $pdf->SetX(133);$pdf->Cell(5,5,number_format($grupo_part->fields['por_jun'],0,',','.'),0,0,'R');$pdf->Cell(1,5,'%');$pdf->SetTextColor(0,240,0);$pdf->Cell(2,5,'');$pdf->Cell(2,5,'E');
					}}$pdf->SetTextColor(0,0,0);
					...
					if($grupo_part->fields['por_jul']>=0) 
					{
						if($grupo_part->fields['por_jul']<=40) 
					         {
						   $pdf->SetX(152); $pdf->Cell(5,5,number_format($grupo_part->fields['por_jul'],0,',','.'),0,0,'R');$pdf->Cell(1,5,'%'); $pdf->SetTextColor(255,0,0);$pdf->Cell(2,5,'');$pdf->Cell(2,5,'D');
					...
					if($grupo_part->fields['por_jul']>=41) 
					{
						if($grupo_part->fields['por_jul']<=80) 
					         {
						   $pdf->SetX(152);$pdf->Cell(5,5,number_format($grupo_part->fields['por_jul'],0,',','.'),0,0,'R');$pdf->Cell(1,5,'%');$pdf->SetTextColor(230,230,0);$pdf->Cell(2,5,'');$pdf->Cell(2,5,'R');
					...
					if($grupo_part->fields['por_jul']>=81) 
					{
						if($grupo_part->fields['por_jul']<=120) 
					         {
						   $pdf->SetX(152);$pdf->Cell(5,5,number_format($grupo_part->fields['por_jul'],0,',','.'),0,0,'R');$pdf->Cell(1,5,'%');$pdf->SetTextColor(0,240,0);$pdf->Cell(2,5,'');$pdf->Cell(2,5,'E');
					}}$pdf->SetTextColor(0,0,0);
					...
					if($grupo_part->fields['por_ago']>=0) 
					{
						if($grupo_part->fields['por_ago']<=40) 
					         {
						   $pdf->SetX(169);$pdf->Cell(5,5,number_format($grupo_part->fields['por_ago'],0,',','.'),0,0,'R');$pdf->Cell(1,5,'%');$pdf->SetTextColor(255,0,0);$pdf->Cell(2,5,'');$pdf->Cell(2,5,'D');
					...
					if($grupo_part->fields['por_ago']>=41) 
					{
						if($grupo_part->fields['por_ago']<=80) 
					         {
						   $pdf->SetX(169);$pdf->Cell(5,5,number_format($grupo_part->fields['por_ago'],0,',','.'),0,0,'R');$pdf->Cell(1,5,'%'); $pdf->SetTextColor(230,230,0);$pdf->Cell(2,5,'');$pdf->Cell(2,5,'R');
					...
					if($grupo_part->fields['por_ago']>=81) 
					{
						if($grupo_part->fields['por_ago']<=120) 
					         {
						   $pdf->SetX(169);$pdf->Cell(5,5,number_format($grupo_part->fields['por_ago'],0,',','.'),0,0,'R');$pdf->Cell(1,5,'%'); $pdf->SetTextColor(0,240,0);$pdf->Cell(2,5,'');$pdf->Cell(2,5,'E');
					}}$pdf->SetTextColor(0,0,0);
					...
					if($grupo_part->fields['por_sep']>=0) 
					{
						if($grupo_part->fields['por_sep']<=40) 
					         {
						   $pdf->SetX(187);$pdf->Cell(5,5,number_format($grupo_part->fields['por_sep'],0,',','.'),0,0,'R');$pdf->Cell(1,5,'%'); $pdf->Cell(1,5,'');$pdf->SetTextColor(255,0,0);$pdf->Cell(2,5,'');$pdf->Cell(2,5,'D');
					...
					if($grupo_part->fields['por_sep']>=41) 
					{
						if($grupo_part->fields['por_sep']<=80) 
					         {
						   $pdf->SetX(187);$pdf->Cell(5,5,number_format($grupo_part->fields['por_sep'],0,',','.'),0,0,'R');$pdf->Cell(1,5,'%'); $pdf->SetTextColor(230,230,0);$pdf->Cell(2,5,'');$pdf->Cell(2,5,'R');
					...
					if($grupo_part->fields['por_sep']>=81) 
					{
						if($grupo_part->fields['por_ago']<=120) 
					         {
						   $pdf->SetX(187);$pdf->Cell(5,5,number_format($grupo_part->fields['por_sep'],0,',','.'),0,0,'R');$pdf->Cell(1,5,'%'); $pdf->SetTextColor(0,240,0);$pdf->Cell(2,5,'');$pdf->Cell(2,5,'E');
					}}$pdf->SetTextColor(0,0,0);

					if($grupo_part->fields['por_sep']>=121) 
					{						
					   $pdf->SetX(187);$pdf->Cell(5,5,number_format($grupo_part->fields['por_sep'],0,',','.'),0,0,'R');$pdf->Cell(1,5,'%'); $pdf->SetTextColor(255,0,0);$pdf->Cell(2,5,'');$pdf->Cell(2,5,'D');
					...
					if($grupo_part->fields['por_oct']>=0) 
					{
						if($grupo_part->fields['por_oct']<=40) 
					         {
						   $pdf->SetX(207);$pdf->Cell(5,5,number_format($grupo_part->fields['por_oct'],0,',','.'),0,0,'R');$pdf->Cell(1,5,'%');$pdf->SetTextColor(255,0,0);$pdf->Cell(2,5,'');$pdf->Cell(2,5,'D');
					...
					if($grupo_part->fields['por_oct']>=41) 
					{
						if($grupo_part->fields['por_oct']<=80) 
					         {
						   $pdf->SetX(207);$pdf->Cell(5,5,number_format($grupo_part->fields['por_oct'],0,',','.'),0,0,'R');$pdf->Cell(1,5,'%'); $pdf->SetTextColor(230,230,0);$pdf->Cell(2,5,'');$pdf->Cell(2,5,'R');
					...
					if($grupo_part->fields['por_oct']>=81) 
					{
						if($grupo_part->fields['por_oct']<=120) 
					         {
						   $pdf->SetX(207);$pdf->Cell(5,5,number_format($grupo_part->fields['por_oct'],0,',','.'),0,0,'R');$pdf->Cell(1,5,'%'); $pdf->SetTextColor(0,240,0);$pdf->Cell(2,5,'');$pdf->Cell(2,5,'E');
					}}$pdf->SetTextColor(0,0,0);
					...
					if($grupo_part->fields['por_nov']>=0) 
					{
						if($grupo_part->fields['por_nov']<=40) 
					         {
						   $pdf->SetX(224);$pdf->Cell(5,5,number_format($grupo_part->fields['por_nov'],0,',','.'),0,0,'R');$pdf->Cell(1,5,'%');$pdf->SetTextColor(255,0,0);$pdf->Cell(2,5,'');$pdf->Cell(2,5,'D');
					...
					if($grupo_part->fields['por_nov']>=41) 
					{
						if($grupo_part->fields['por_nov']<=80) 
					         {
						   $pdf->SetX(224);$pdf->Cell(5,5,number_format($grupo_part->fields['por_nov'],0,',','.'),0,0,'R');$pdf->Cell(1,5,'%');  $pdf->SetTextColor(230,230,0);$pdf->Cell(2,5,'');$pdf->Cell(2,5,'R');
					...
					if($grupo_part->fields['por_nov']>=81) 
					{
						if($grupo_part->fields['por_nov']<=120) 
					         {
						   $pdf->SetX(224);$pdf->Cell(5,5,number_format($grupo_part->fields['por_nov'],0,',','.'),0,0,'R');$pdf->Cell(1,5,'%'); $pdf->SetTextColor(0,240,0);$pdf->Cell(2,5,'');$pdf->Cell(2,5,'E');
					}}$pdf->SetTextColor(0,0,0);
					...
					if($grupo_part->fields['por_dic']>=0) 
					{
						if($grupo_part->fields['por_dic']<=40) 
					         {
						 $pdf->SetX(243);$pdf->Cell(5,5,number_format($grupo_part->fields['por_dic'],0,',','.'),0,0,'R');$pdf->Cell(1,5,'%');$pdf->SetTextColor(255,0,0);$pdf->Cell(2,5,'');$pdf->Cell(2,5,'D');
					...
					if($grupo_part->fields['por_dic']>=41) 
					{
						if($grupo_part->fields['por_dic']<=80) 
					         {
						   $pdf->SetX(243);$pdf->Cell(5,5,number_format($grupo_part->fields['por_dic'],0,',','.'),0,0,'R');$pdf->Cell(1,5,'%');  $pdf->SetTextColor(230,230,0);$pdf->Cell(2,5,'');$pdf->Cell(2,5,'R');
					...
					if($grupo_part->fields['por_dic']>=81) 
					{
						if($grupo_part->fields['por_dic']<=120) 
					         {
						   $pdf->SetX(243);$pdf->Cell(5,5,number_format($grupo_part->fields['por_dic'],0,',','.'),0,0,'R');$pdf->Cell(1,5,'%'); $pdf->SetTextColor(0,240,0);$pdf->Cell(2,5,'');$pdf->Cell(2,5,'E');
					}}$pdf->SetTextColor(0,0,0);
					...
					if($grupo_part->fields['por_total']>=0) 
					{
						if($grupo_part->fields['por_total']<=40) 
					         {
						   $pdf->SetX(262); $pdf->Cell(5,5,number_format($grupo_part->fields['por_total'],0,',','.'),0,0,'R');$pdf->Cell(1,5,'%'); $pdf->SetTextColor(255,0,0);$pdf->Cell(2,5,'');$pdf->Cell(2,5,'D');
					...
					if($grupo_part->fields['por_dic']>=41) 
					{
						if($grupo_part->fields['por_total']<=80) 
					         {
						   $pdf->SetX(262);$pdf->Cell(5,5,number_format($grupo_part->fields['por_total'],0,',','.'),0,0,'R');$pdf->Cell(1,5,'%');  $pdf->SetTextColor(230,230,0);$pdf->Cell(2,5,'');$pdf->Cell(2,5,'R');
					...
					if($grupo_part->fields['por_dic']>=81) 
					{
						if($grupo_part->fields['por_total']<=120) 
					         {
						   $pdf->SetX(262);$pdf->Cell(5,5,number_format($grupo_part->fields['por_total'],0,',','.'),0,0,'R');$pdf->Cell(1,5,'%'); $pdf->SetTextColor(0,240,0);$pdf->Cell(2,5,'');$pdf->Cell(2,5,'E');
					}}$pdf->SetTextColor(0,0,0);
