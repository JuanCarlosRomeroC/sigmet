...
<TABLE border=0 cellSpacing=0 cellPadding=0 width="100%">
        ...
        <tbody>
          <tr>
            <td class=nombreBarra width="80%" align=left><img align=top src="../../images/online.png" />
              <?php 
	  echo $_SESSION['seniat_users_id_sigme']." - ".$_SESSION['seniat_users_nombre_sigme']; ?></td>
  ...
  <TR>
	...
	<UL id=qm0 class=qmmc>
    	 <LI><A class=qmparent 
        	href="index.php" 
        	target=_parent>Principal</A> 
        </LI>
        <LI><A class=qmparent 
        	href="../formulacion/plan.php" 
        	target=_parent>Ejecuci&oacute;n del Plan</A> 
        </LI>
        <LI><A class=qmparent 
        	href="../formulacion/presupuesto.php" 
        	target=_parent>Formulaci&oacute;n del Presupuesto</A> 
        </LI>
        <LI><A class=qmparent 
	...
	<LI><A class=qmparent 
        	href="../../../../../index.php?option=com_phocadownload&view=category&id=11:des-cat-eje-info&Itemid=54" 
