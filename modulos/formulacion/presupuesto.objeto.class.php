...
class clase_presupuesto
{
 ...
 public function Clase_GuardarPart() 
 {
    ...
    $SQL = "call grabar_part ('$this->pry', '$this->ae', '$this->eje', '$this->part', '$this->part_ene', '$this->part_feb', '$this->part_mar', '$this->part_abr', '$this->part_may', '$this->part_jun', '$this->part_jul', '$this->part_ago', '$this->part_sep', '$this->part_oct', '$this->part_nov', '$this->part_dic')";
    $db=DB_CONECCION();
 ...
 {
    if ($this->error!="")return $array=array(false,$this->error,0);
    $SQL = "call borrar_part ('$this->ae', '$this->eje', '$this->part')";
	$db=DB_CONECCION();
